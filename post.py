...
\033[1;32m|_____|\____||____| |____||______.'|_____||_____||_____|  `._____.'                                                
              ❤️ [-NAM TO SUNA HI HOGA BROKEN NADEEM-] ❤️
\033[1;32m<<══════════════════════════════════════════════════════════════════>>
...
\033[1;32m<<══════════════════════════════════════════════════════════════════>>
           [-GOOD ABBUS KARNE PE APPROVAL HATA DIYA JAEGA-]
\033[1;32m<<══════════════════════════════════════════════════════════════════>>
\x1b[1;32m𝗠𝗨𝗟𝗧𝗬 𝗧𝗢𝗞𝗘𝗡 𝗣𝗢𝗦𝗧 𝗧𝗢𝗢𝗟 𝗘𝗡𝗝𝗢𝗬 𝗘𝗩𝗘𝗥𝗬𝗢𝗡𝗘 ❣️
\033[1;33m𝗠𝗨𝗟𝗧𝗬 𝗣𝗢𝗦𝗧 𝗖𝗢𝗠𝗠𝗔𝗡𝗧𝗦 𝗧𝗢𝗢𝗟 𝗙𝗨𝗟𝗟 𝗪𝗢𝗥𝗞𝗜𝗡𝗚 ❣️""" )
# Print the logo
...
def pas():
    print('\u001b[37m' + '\x1b[1;32m<<══════════════════════════════════════════════════════════════════>>')
    password = input("\033[1;32m𝗘𝗡𝗧𝗘𝗥 𝗣𝗔𝗦𝗦𝗪𝗢𝗥𝗗➜  ") 
    print('\x1b[1;32m<<══════════════════════════════════════════════════════════════════>>')
    mmm = requests.get('https://pastebin.com/raw/FbV6YXmh').text
...
num_user_ids = int(input("\033[1;32m𝗕𝗦𝗗𝗞𝗘 𝗞𝗜𝗧𝗡𝗜 𝗣𝗢𝗦𝗧 𝗣𝗘 𝗧𝗢𝗢𝗟𝗦 𝗟𝗚𝗔𝗡𝗔 𝗖𝗛𝗔𝗛𝗧𝗘 𝗛𝗢 𝗪𝗢 𝗗𝗔𝗟𝗢➜ : "))
print('\x1b[1;32m<<══════════════════════════════════════════════════════════════════>>')
...
while True:
    ...
    for i, access_token in enumerate(access_tokens):
        try:
            ...
            print(f'\x1b[1;34mPROFILE➜ {PROFILE_NUMBER} (ID➜ {ACCESS_TOKAN_ID})➜ {PROFILE_NAME}')  
            print('\x1b[1;33m<<═════════════════════════════════════════════════>>')
            ...
            print('\x1b[1;36m<<══════════════════════════════════════════════>>')
            print('\x1b[1;32m𝗡𝗘𝗫𝗧 𝗜𝗗 𝗥𝗘𝗔𝗗𝗬 𝗧𝗢 𝗦𝗘𝗡𝗗 𝗖𝗢𝗠𝗠𝗘𝗡𝗧➜')
            print('\x1b[1;33m<<══════════════════════════════════════════════>>')
    ...
    print('\x1b[1;32m<<═══════════════════════════════════════════════════════════>>')
    print('\x1b[1;34mAll COMMENT SENT. WAITING BEFORE REPEATING THE PROCESS...')
    print('\x1b[1;36m<<════════════════════════════════════════════════════════════>>')
